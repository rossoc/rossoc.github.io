...
Recent research has explored the relationship between **Neural Network (NN) complexity** and **Kolmogorov complexity** ([Sakabe et al., 2025](https://rossoc.github.io/notes/MoMos2D#ref-sakabe); [Bakhtiarifard et al., 2026](https://rossoc.github.io/notes/MoMos2D#ref-momo)). 

### 1. Complexity and Generalization
Specifically, [Sakabe et al. (2025)](https://rossoc.github.io/notes/MoMos2D#ref-sakabe) demonstrate that approximating the Kolmogorov complexity of Binarized NNs provides critical insights into training dynamics and correlates strongly with generalization capabilities. 
...
Building on these foundations, the **Mosaic-of-Motifs (MoMo)** framework ([Bakhtiarifard et al., 2026](https://rossoc.github.io/notes/MoMos2D#ref-momo)) provides a reliable method to bound Kolmogorov complexity from above by decoupling a model's weights from its architecture. 
